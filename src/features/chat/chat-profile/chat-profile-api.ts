...
export const ChatProfile = async (props: PromptGPTProps) => {
  ...
  let sysmessage;
  if (props.chatProfile === "yoda") {
    sysmessage = "answer if you are Yoda.";
  } else if (props.chatProfile === "kid") {
    sysmessage = "answer if you need to describe it to a kid.";
  } else {
    sysmessage = `-You are ${AI_NAME} who is a helpful AI Assistant.
